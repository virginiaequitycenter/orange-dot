...
```{r workers_by_hours, fig.width = 9, fig.height = 4.5, fig.align = "center"}
...
```{r family_income, fig.width = 9, fig.height = 4.5, fig.align = "center"}
...
```{r workers_by_medianwages, fig.width = 9, fig.height = 4.5, fig.align = "center"}
...
```{r, fig.align = "center"}
knitr::include_graphics("../final_report/average-family-wealth-by-race-and-ethnicity-1963-2022.png")
```
...
The authors of this report are: 
  ...
  * Elizabeth Mitchell, Data Scientist of Equitable Analysis, The Equity Center, University of Virginia.
...
### Citation
Elizabeth Mitchell, Michele Claibourn, Ridge Schuyler. “Orange Dot Report 6.0: Family Self-Sufficiency in the Charlottesville Region: Albemarle, Buckingham, Fluvanna, Greene, Louisa, Nelson Counties & the City of Charlottesville, Virginia.” Published October 21, 2024. https://www.virginiaequitycenter.org/orange-dot-report.

This work is licensed under a [Creative Commons Attribution 4.0 International License](https://creativecommons.org/licenses/by/4.0/).

## Appendix

[Download the report pdf](https://virginiaequitycenter.github.io/cville-equity-atlas/pages/reports/report-pdfs/orange-dot-6-final-print.pdf) for tables on expenses and self-sufficiency wages for different family compositions for each locality in this report.
