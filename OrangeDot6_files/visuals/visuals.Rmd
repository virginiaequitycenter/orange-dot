...
# pal_inc <- colorBin(pal_vector, 
#                 domain = med_faminc_tract$estimate)
# pal_ssw <- colorBin(pal_vector, 
#                 domain = ssw_tract$percent)
...
alb_inc_map <- med_faminc_tract %>%
  ...
  scale_fill_stepsn(colors = rev(pal_inc),
                    ...
                    guide = guide_colourbar(title = "Median Family Income",
                                            ...
                                            # title.hjust = 0.5,
                                            # nbin = 6,
                                            theme = theme(legend.key.height  = unit(12, "lines"),
...
alb_ssw_map <- ssw_tract %>%
  ...
  labs(title = "Families with Income below Self Sufficiency Standard by Census Tract",
      subtitle = "Albemarle",
      caption = "") +
  theme_map()+
  theme(legend.position="right")
