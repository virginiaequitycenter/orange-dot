...
occupations_filtered %>%
  ...
  tab_footnote(
    footnote = "Employment rate per 1,000 jobs in the Charlottesville Metro Area",
  ...
  tab_source_note(
    source_note = "U.S. Bureau of Labor Statistics, Occupational Employment and Wage Statistics; May 2023"
  )
```
