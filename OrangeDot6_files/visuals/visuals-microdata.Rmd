...
```{r race_by_percent, fig.width = 9.5, fig.height = 6, fig.retina = 2, out.width = '100%'}
...
```{r age_butterfly_percent, fig.width = 10.5, fig.height=6, fig.retina = 2, out.width = '100%'}
...
```{r tenure-stacked, fig.width=9.5, fig.height=5, fig.retina = 2, out.width = '100%'}
...
```{r burden, fig.width=9.5, fig.height=5, fig.retina = 2, out.width = '100%'}
...
```{r disability, fig.width=9.5, fig.height=5, fig.retina = 2, out.width = '100%'}
...
```{r workers_by_hours, fig.width = 9.5, fig.height = 6, fig.retina = 2, out.width = '100%'}
...
```{r workers_by_medianwages, fig.width = 10, fig.height = 6, fig.retina = 2, out.width = '100%'}
...
```
```{r occupations_by_wagebin, fig.width = 6, fig.height = 10,  fig.retina = 2, out.width = '100%'}
...
occupations_filtered %>%
  ...
  tab_footnote(
    footnote = "See Appendix for more occupations",
    locations = cells_title(groups = "title")
  ) %>% 
  tab_footnote(
    footnote = "Employment rate per 1,000 jobs",
