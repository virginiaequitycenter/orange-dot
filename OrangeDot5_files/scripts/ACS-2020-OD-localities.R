...
names(county_data_s) = c("GEOID", "NAME",
                        ...
                        "unempE", "unempM",
                        "ownerCarAccessE", "ownerCarAccessM",
...
county_AllFam <- get_acs(geography = "county", 
                        table = "B19101", 
                        state = "VA", 
                        county = region, 
                        survey = "acs5",
...
county_AllFamUnder10k <- county_AllFam %>% 
...
county_AllFamBtw10_14k <- county_AllFam %>% 
...
county_AllFamBtw15_24k <- county_AllFam %>% 
...
county_AllFamBtw15_24k$perc_AllFamBtw15_24kE <- round(county_AllFamBtw15_24k$AllFamBtw15_24kE / AllFamT$AllFamE * 100, 2)
county_AllFamBtw15_24k$perc_AllFamBtw15_24kM <- round(moe_prop(county_AllFamBtw15_24k$AllFamBtw15_24kE, AllFamT$AllFamE, 
                                                              county_AllFamBtw15_24k$AllFamBtw15_24kM, AllFamT$AllFamM), 2)

# All families making 25-34,999k
county_AllFamBtw25_34k <- county_AllFam %>% 
...
county_AllFamBtw25_34k$perc_AllFamBtw25_34kE <- round(county_AllFamBtw25_34k$AllFamBtw25_34kE / AllFamT$AllFamE * 100, 2)
county_AllFamBtw25_34k$perc_AllFamBtw25_34kM <- round(moe_prop(county_AllFamBtw25_34k$AllFamBtw25_34kE, AllFamT$AllFamE, 
                                                              county_AllFamBtw25_34k$AllFamBtw25_34kM, AllFamT$AllFamM), 2)

# All families making Under 35k
county_AllFamUnder35k <- county_AllFam %>% 
...
county_AllFamOver100$perc_AllFamOver100kE <- round(county_AllFamOver100$AllFamOver100kE / AllFamT$AllFamE * 100, 2)
county_AllFamOver100$perc_AllFamOver100kM <- round(moe_prop(county_AllFamOver100$AllFamOver100kE, AllFamT$AllFamE, 
                                                           county_AllFamOver100$AllFamOver100kM, AllFamT$AllFamM), 2)




# Family income -- White families  #########################
county_White <- get_acs(geography = "county", 
                       table = "B19101A", 
                       state = "VA", 
                       county = region, 
                       survey = "acs5",
...
county_WhiteFamUnder10k <- county_White %>% 
  filter(variable == "B19101A_002") %>% 
  rename(WhiteFamUnder10kE = estimate,
         WhiteFamUnder10kM = moe) %>% 
  dplyr::select(-variable) %>%
  mutate(perc_WhiteFamUnder10kE = round(WhiteFamUnder10kE / county_WhiteAll$AllWhiteFamE * 100, 2),
         perc_WhiteFamUnder10kM = round(moe_prop(WhiteFamUnder10kE, county_WhiteAll$AllWhiteFamE, 
                                                 WhiteFamUnder10kM, county_WhiteAll$AllWhiteFamM), 2))

# White families making 10-14,999k
county_WhiteFamBtw10_14k <- county_White %>% 
  filter(variable == "B19101A_003") %>% 
  rename(WhiteFamBtw10_14kE = estimate,
         WhiteFamBtw10_14kM = moe) %>% 
  dplyr::select(-variable) %>%
  mutate(perc_WhiteFamBtw10_14kE = round(WhiteFamBtw10_14kE / county_WhiteAll$AllWhiteFamE * 100, 2),
         perc_WhiteFamBtw10_14kM = round(moe_prop(WhiteFamBtw10_14kE, county_WhiteAll$AllWhiteFamE, 
                                                  WhiteFamBtw10_14kM, county_WhiteAll$AllWhiteFamM), 2))

# White families making 15-24,999k
county_WhiteFamBtw15_24k <- county_White %>% 
...
county_WhiteFamBtw15_24k$perc_WhiteFamBtw15_24kE <- round(county_WhiteFamBtw15_24k$WhiteFamBtw15_24kE / county_WhiteAll$AllWhiteFamE * 100, 2)
county_WhiteFamBtw15_24k$perc_WhiteFamBtw15_24kM <- round(moe_prop(county_WhiteFamBtw15_24k$WhiteFamBtw15_24kE, county_WhiteAll$AllWhiteFamE, 
                                                                  county_WhiteFamBtw15_24k$WhiteFamBtw15_24kM, county_WhiteAll$AllWhiteFamM), 2)

# White families making 25-34,999k
county_WhiteFamBtw25_34k <- county_White %>% 
...
county_WhiteFamBtw25_34k$perc_WhiteFamBtw25_34kE <- round(county_WhiteFamBtw25_34k$WhiteFamBtw25_34kE / county_WhiteAll$AllWhiteFamE * 100, 2)
county_WhiteFamBtw25_34k$perc_WhiteFamBtw25_34kM <- round(moe_prop(county_WhiteFamBtw25_34k$WhiteFamBtw25_34kE, county_WhiteAll$AllWhiteFamE, 
                                                               county_WhiteFamBtw25_34k$WhiteFamBtw25_34kM, county_WhiteAll$AllWhiteFamM), 2)

# White families making Under 35k
county_WhiteFamUnder35k <- county_White %>% 
...
county_WhiteFamOver100$perc_WhiteFamOver100kE <- round(county_WhiteFamOver100$WhiteFamOver100kE / county_WhiteAll$AllWhiteFamE * 100, 2)
county_WhiteFamOver100$perc_WhiteFamOver100kM <- round(moe_prop(county_WhiteFamOver100$WhiteFamOver100kE, county_WhiteAll$AllWhiteFamE, 
                                                               county_WhiteFamOver100$WhiteFamOver100kM, county_WhiteAll$AllWhiteFamM), 2)




# Family income -- Black families  #########################
county_Black <- get_acs(geography = "county", 
                       table = "B19101B", 
                       state = "VA", 
                       county = region, 
                       survey = "acs5",
...
county_BlackFamUnder10k <- county_Black %>% 
  filter(variable == "B19101B_002") %>% 
  rename(BlackFamUnder10kE = estimate,
         BlackFamUnder10kM = moe) %>% 
  dplyr::select(-variable) %>%
  mutate(perc_BlackFamUnder10kE = round(BlackFamUnder10kE / county_BlackAll$AllBlackFamE * 100, 2),
         perc_BlackFamUnder10kM = round(moe_prop(BlackFamUnder10kE, county_BlackAll$AllBlackFamE, 
                                                 BlackFamUnder10kM, county_BlackAll$AllBlackFamM), 2))

# Black families making 10-14,999k
county_BlackFamBtw10_14k <- county_Black %>% 
  filter(variable == "B19101B_003") %>% 
  rename(BlackFamBtw10_14kE = estimate,
         BlackFamBtw10_14kM = moe) %>% 
  dplyr::select(-variable) %>%
  mutate(perc_BlackFamBtw10_14kE = round(BlackFamBtw10_14kE / county_BlackAll$AllBlackFamE * 100, 2),
         perc_BlackFamBtw10_14kM = round(moe_prop(BlackFamBtw10_14kE, county_BlackAll$AllBlackFamE, 
                                                  BlackFamBtw10_14kM, county_BlackAll$AllBlackFamM), 2))

# Black families making 15-24,999k
county_BlackFamBtw15_24k <- county_Black %>% 
...
county_BlackFamBtw15_24k$perc_BlackFamBtw15_24kE <- round(county_BlackFamBtw15_24k$BlackFamBtw15_24kE / county_BlackAll$AllBlackFamE * 100, 2)
county_BlackFamBtw15_24k$perc_BlackFamBtw15_24kM <- round(moe_prop(county_BlackFamBtw15_24k$BlackFamBtw15_24kE, county_BlackAll$AllBlackFamE, 
                                                                  county_BlackFamBtw15_24k$BlackFamBtw15_24kM, county_BlackAll$AllBlackFamM), 2)

# Black families making 25-34,999k
county_BlackFamBtw25_34k <- county_Black %>% 
...
county_BlackFamBtw25_34k$perc_BlackFamBtw25_34kE <- round(county_BlackFamBtw25_34k$BlackFamBtw25_34kE / county_BlackAll$AllBlackFamE * 100, 2)
county_BlackFamBtw25_34k$perc_BlackFamBtw25_34kM <- round(moe_prop(county_BlackFamBtw25_34k$BlackFamBtw25_34kE, county_BlackAll$AllBlackFamE, 
                                                                  county_BlackFamBtw25_34k$BlackFamBtw25_34kM, county_BlackAll$AllBlackFamM), 2)

# Black families making Under 35k
county_BlackFamUnder35k <- county_Black %>% 
...
county_BlackFamOver100$perc_BlackFamOver100kE <- round(county_BlackFamOver100$BlackFamOver100kE / county_BlackAll$AllBlackFamE * 100, 2)
county_BlackFamOver100$perc_BlackFamOver100kM <- round(moe_prop(county_BlackFamOver100$BlackFamOver100kE, county_BlackAll$AllBlackFamE, 
                                                               county_BlackFamOver100$BlackFamOver100kM, county_BlackAll$AllBlackFamM), 2)
...
county_data <- county_data_s %>%
  left_join(AllFamT) %>%
  left_join(county_AllFamUnder10k) %>%
  left_join(county_AllFamBtw10_14k) %>%
  ...
  left_join(county_WhiteFamBtw10_14k) %>%
  ...
  left_join(county_BlackFamBtw10_14k) %>%
...
county_data$locality <- as.character(county_data$locality)

county_data$countyName <- recode(county_data$locality, "540" = "Charlottesville", "029" = "Buckingham", "065" = "Fluvanna",
...
## adding all columns that are counts for the individual localities to get a total number for the entire region
# cannot do this by selecting columns that end in E, because the percent estimates also end in E. 
# instead, I'm just naminng all of the columns of interest. 
...
# I'm ignoring the margin of error columns (those that end in M) because it seems unlikely that they'll get used for the whole
# region 

wregion <- wregion %>%
  mutate(medianHHIE = median(county_data$medianHHIE),
         medianHHIWhiteE = median(county_data$medianHHIWhiteE),
         medianHHIBlackE = median(county_data$medianHHIBlackE),
         perc_noHSE = round(noHSE/pop25olderE * 100, 2),
         medianFamIncomeE = median(county_data$medianFamIncomeE),
         perc_AllFamUnder10kE = round(AllFamUnder10kE/AllFamE * 100, 2),
         perc_AllFamBtw10_14kE = round(AllFamBtw10_14kE/AllFamE * 100, 2),
...
# joining whole region estimates with the localities 
county_data <- rbind(county_data, wregion)

# ....................................................
# 4. Save #########################
write.csv(county_data, "acs_county_orangedot.csv", row.names = F) 
