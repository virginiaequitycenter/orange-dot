...
The following map shows the number of low-paid families rather than the percent. 

##### Number of Families Making under $35,000 in Albemarle County
```{r}
pal2_vector <- c("#E34400","#EF6901","#F99306","#CCAF2E","#4DB48A","#41AAAA")

pal2 <- colorBin(pal2_vector, 
                domain = geofull$AllFamUnder35kE,
                reverse = TRUE)
...
leaflet() %>% 
  ...
  addProviderTiles("CartoDB.Positron") %>% 
  addPolygons(data = ACmap,
              fillColor = ~pal2(AllFamUnder35kE),
              weight = 1,
              opacity = 1,
              color = "white", 
              fillOpacity = 0.6,
              ...
              popup = paste0("Number of families: ", ACmap$AllFamUnder35kE, "<br>",
                             "Census Tract: ", ACmap$NAME.x, "<br>",
                             "Area Name: ", ACmap$tractname)) %>% 
  addLegend("bottomright", pal = pal2, values = ACmap$AllFamUnder35kE, 
            title = "Number of families <br> making < $35,000", opacity = 0.7)
```
...
##### Number of Families Making under $35,000 in Buckingham County
```{r}
pal2_vector <- c("#E34400","#EF6901","#F99306","#CCAF2E","#4DB48A","#41AAAA")
...
leaflet() %>% 
  ...
  addPolygons(data = BCmap,
              ...
              popup = paste0("Number of families: ", BCmap$AllFamUnder35kE, "<br>",
                             "Census Tract: ", BCmap$NAME.x, "<br>",
                             "Area Name: ", BCmap$tractname)) %>% 
  addLegend("bottomright", pal = pal2, values = BCmap$AllFamUnder35kE, 
            title = "Number of families <br> making < $35,000", opacity = 0.7)
```
[Return to Localities ↩︎](#localities)
...
##### Number of Families Making under $35,000 in Charlottesville City
```{r}
pal2_vector <- c("#E34400","#EF6901","#F99306","#CCAF2E","#4DB48A","#41AAAA")
...
leaflet() %>% 
  ...
  addPolygons(data = CCmap,
              ...
              popup = paste0("Number of families: ", CCmap$AllFamUnder35kE, "<br>",
                             "Census Tract: ", CCmap$NAME.x, "<br>",
                             "Area Name: ", CCmap$tractname)) %>% 
  addLegend("bottomright", pal = pal2, values = CCmap$AllFamUnder35kE, 
            title = "Number of families <br> making < $35,000", opacity = 0.7)
```
[Return to Localities ↩︎](#localities)
...
##### Number of Families Making under $35,000 in Fluvanna County
```{r}
pal2_vector <- c("#E34400","#EF6901","#F99306","#CCAF2E","#4DB48A","#41AAAA")
...
leaflet() %>% 
  ...
  addPolygons(data = FCmap,
              ...
              popup = paste0("Number of families: ", FCmap$AllFamUnder35kE, "<br>",
                             "Census Tract: ", FCmap$NAME.x, "<br>",
                             "Area Name: ", FCmap$tractname)) %>% 
  addLegend("bottomright", pal = pal2, values = FCmap$AllFamUnder35kE, 
            title = "Number of families <br> making < $35,000", opacity = 0.7)
```
[Return to Localities ↩︎](#localities)
...
##### Number of Families Making under $35,000 in Greene County
```{r}
pal2_vector <- c("#E34400","#EF6901","#F99306","#CCAF2E","#4DB48A","#41AAAA")
...
leaflet() %>% 
  ...
  addPolygons(data = GCmap,
              ...
              popup = paste0("Number of families: ", GCmap$AllFamUnder35kE, "<br>",
                             "Census Tract: ", GCmap$NAME.x, "<br>",
                             "Area Name: ", GCmap$tractname)) %>% 
  addLegend("bottomright", pal = pal2, values = GCmap$AllFamUnder35kE, 
            title = "Number of families <br> making < $35,000", opacity = 0.7)
```
[Return to Localities ↩︎](#localities)
...
##### Number of Families Making under $35,000 in Louisa County
```{r}
pal2_vector <- c("#E34400","#EF6901","#F99306","#CCAF2E","#4DB48A","#41AAAA")
...
leaflet() %>% 
  ...
  addPolygons(data = LCmap,
              ...
              popup = paste0("Number of families: ", LCmap$AllFamUnder35kE, "<br>",
                             "Census Tract: ", LCmap$NAME.x, "<br>",
                             "Area Name: ", LCmap$tractname)) %>% 
  addLegend("bottomright", pal = pal2, values = LCmap$AllFamUnder35kE, 
            title = "Number of families <br> making < $35,000", opacity = 0.7)
```
[Return to Localities ↩︎](#localities)
...
##### Number of Families Making under $35,000 in Nelson County
```{r}
pal2_vector <- c("#E34400","#EF6901","#F99306","#CCAF2E","#4DB48A","#41AAAA")
...
leaflet() %>% 
  ...
  addPolygons(data = NCmap,
              ...
              popup = paste0("Number of families: ", NCmap$AllFamUnder35kE, "<br>",
                             "Census Tract: ", NCmap$NAME.x, "<br>",
                             "Area Name: ", NCmap$tractname)) %>% 
  addLegend("bottomright", pal = pal2, values = NCmap$AllFamUnder35kE, 
            title = "Number of families <br> making < $35,000", opacity = 0.7)
```
[Return to Localities ↩︎](#localities)
