...
The Stanardsville tract has the lowest median family incomes at `r comma(GCmap$medianFamIncomeE[GCmap$tractnames == "Stanardsville"])`, and the Midway tract has the highest family median income at `r paste0(comma(GCmap$medianFamIncomeE[GCmap$tractnames == "Midway"]))`. 
...
The Lovingston tract has the lowest median family incomes at `r comma(NCmap$medianFamIncomeE[NCmap$tractnames == "Lovingston"])`, and the Zion Crossroads tract has the highest family median income at `r comma(NCmap$medianFamIncomeE[NCmap$tractnames == "Wintergreen-Rockfish Valley"])`. 
